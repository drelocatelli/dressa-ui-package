...
import { createContext, useState, createRef, useContext } from 'react';
...
var NavDropdown = function (props) {
    var _a;
    var dropdownExpanded = createRef();
    ...
    return (jsx(Fragment, { children: jsxs("div", __assign({ className: "dropdown-expanded", id: props.id, ref: dropdownExpanded }, { children: [jsx("li", __assign({ className: "dropdown-menu", onClick: detectDropdownClick }, { children: jsxs("a", __assign({ href: "javascript:void(0);" }, { children: [props.title, "\u00A0", (_a = props.icon) !== null && _a !== void 0 ? _a : jsx(Icon, { name: "arrow_drop_down" })] })) })), jsx("ul", __assign({ className: "dropdown", id: props.id }, { children: props.children }))] })) }));
};
var NavDropDownItem = function (props) {
    return (jsx(Fragment, { children: jsx("li", __assign({ style: props["li-style"] }, { children: jsx("a", __assign({ href: props.href, style: props["a-style"] }, { children: props.children })) })) }));
};
var NavdropdownDivider = function (props) {
    var darkMode = useContext(ThemeContext).darkMode;
    return (jsx(NavSeparator, { darkMode: darkMode, style: props.style }));
};
//*-------------------------------------------- childs
...
function Form(props) {
    return (jsx(FormStyled, { children: jsx("form", __assign({}, props, { children: props.children })) }));
}
function Button(props) {
    return jsx(ButtonStyled, __assign({ style: props.style, bg: props.bg }, { children: props.children }));
}
...
var ButtonStyled = styled.button(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n    padding:0 1rem;\n    border-radius: 0.375rem;\n    margin: 3px;\n    background: ", ";\n    height: 2.5rem;\n    box-sizing:border-box;\n    border:0;\n    outline: 0;\n    opacity: .9;\n    cursor: pointer;\n\n    &:hover {\n        opacity: 1;\n    }\n\n    &:active {\n        opacity: .8;\n\n    }\n"], ["\n    padding:0 1rem;\n    border-radius: 0.375rem;\n    margin: 3px;\n    background: ", ";\n    height: 2.5rem;\n    box-sizing:border-box;\n    border:0;\n    outline: 0;\n    opacity: .9;\n    cursor: pointer;\n\n    &:hover {\n        opacity: 1;\n    }\n\n    &:active {\n        opacity: .8;\n\n    }\n"])), function (props) { return props.bg; });
var FormStyled = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    display: flex;\n"], ["\n    display: flex;\n"])));
var templateObject_1$1, templateObject_2;

var DressaUIWrapper = createGlobalStyle(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    @font-face {\n        font-family: 'Roboto';\n        src: url('../assets/fonts/Roboto-Regular.ttf');\n    }\n\n    @font-face {\n        font-family: 'Material Icons';\n        src: url('../assets/fonts/Material Icons.woff2') format('woff2');\n    }\n\n    * {\n        font-family: 'Roboto', sans-serif;\n        padding: 0;\n        margin: 0;\n    }\n\n    a {\n        text-decoration: none;\n    }\n"], ["\n    @font-face {\n        font-family: 'Roboto';\n        src: url('../assets/fonts/Roboto-Regular.ttf');\n    }\n\n    @font-face {\n        font-family: 'Material Icons';\n        src: url('../assets/fonts/Material\\ Icons.woff2') format('woff2');\n    }\n\n    * {\n        font-family: 'Roboto', sans-serif;\n        padding: 0;\n        margin: 0;\n    }\n\n    a {\n        text-decoration: none;\n    }\n"])));
var templateObject_1;

export { Button, DressaUIWrapper, Form, Icon, Nav, NavDropdown, Navbar };
